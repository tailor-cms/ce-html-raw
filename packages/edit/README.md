# @tailor-cms/ce-html-raw-edit

Authoring component for the **Raw HTML** content element in [Tailor CMS](https://github.com/tailor-cms/author).
...
```sh
npm install @tailor-cms/ce-html-raw-edit
```
...
```ts
import { Edit } from '@tailor-cms/ce-html-raw-edit';
```
