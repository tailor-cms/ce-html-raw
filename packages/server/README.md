...
Server-side module for the **Raw HTML** content element in [Tailor CMS](https://github.com/tailor-cms/author).
...
```sh
npm install @tailor-cms/ce-html-raw-server
```
...
```ts
import serverModule from '@tailor-cms/ce-html-raw-server';
```
